...
public class ControllerFirstAdmin {
	...
	*/
	...
	/**********
	 * <p> Method: doEmailLogin() </p>
	 * 
	 * <p> Description: This method is called when the user clicks the "Sign in with Email" button.
	 * It redirects to the email registration page where users can create accounts with their email.
	 * 
	 */	
	protected static void doEmailLogin(Stage ps) {
		guiEmailRegister.ViewEmailRegister.displayEmailRegister(ps);
	}
